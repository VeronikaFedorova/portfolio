              ...
              <PinContainer title={title} href={link}>
                <div className='relative flex items-center justify-center sm:w-96 w-[80vw] overflow-hidden h-[20vh] mb-10'>
                  ...
                  <img
                    src={img}
                    alt={title}
                    className='z-10 absolute bottom-0 w-full h-full rounded-xl origin-bottom'
                  />
                </div>
                ...
                <div className='flex items-center justife-between mt-7 mb-3'>
                  <div className='flex items-center'>
                    {iconLists.map((icon, index) => (
                      <div
                        key={icon}
                        className='border border-white/[0.2] rounded-full bg-black lg:w-10 lg:h-10 w-8 h-8 flex justife-center items-center'
